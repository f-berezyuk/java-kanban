...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        File tempFile;
        try {
            File dir = Path.of(System.getProperty("user.dir")).toFile();
            tempFile = File.createTempFile("test", ".csv", dir);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        try (TaskManager manager = Managers.getFileBasedTaskManager(tempFile)) {
